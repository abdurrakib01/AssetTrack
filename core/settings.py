...
SECRET_KEY = 'django-insecure-c=1gg+8=1)$q44_9*)lfr8ta+x-f4t+4nneasb)5^8r0e(_njo'
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Asset Track APIs",
    "DESCRIPTION": """APIs to track corporate assets such as phones, tablets, laptops 
